...
private final Joystick driverJoystick = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    m_chooser.addDefault("DriveXFeed", new DriveXFeet(-6, m_drivetrain));
...
shootAtGoodPresetButton.whileHeld(new ShootAtPercentSpeed(.38, m_shooter) ,true);
    SmartDashboard.putData("ShootAtGoodPresetButton",new ShootAtPercentSpeed(.38, m_shooter) );
