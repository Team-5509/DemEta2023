...
runIntakeArmDown.whileHeld(new RunIntakeArm(.25) ,true);
    SmartDashboard.putData("RunIntakeArmDown",new RunIntakeArm(.25) );

final JoystickButton runIntakeArmUp = new JoystickButton(coPilotJoystick, 12);        
runIntakeArmUp.whileHeld(new RunIntakeArm(-.25) ,true);
    SmartDashboard.putData("RunIntakeArmUp",new RunIntakeArm(-.25) );
...
final JoystickButton shootWithSliderButton = new JoystickButton(coPilotJoystick, 3);        
...
shootAtGoodPresetButton.whileHeld(new ShootAtPercentSpeed(.75, m_shooter) ,true);
    SmartDashboard.putData("ShootAtGoodPresetButton",new ShootAtPercentSpeed(.75, m_shooter) );

final JoystickButton runIntakeButton = new JoystickButton(coPilotJoystick, 2);        
