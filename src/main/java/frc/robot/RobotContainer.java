...
private final Joystick driverJoystick = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    m_chooser.addDefault("DriveXFeet", new DriveXFeet(-6, m_drivetrain));
...
shootAtGoodPresetButton.whileHeld(new ShootAtPercentSpeed(0.456, m_shooter) ,true);
...
shootHighButton.whileHeld(new ShootAtPercentSpeed(0.863, m_shooter) ,true);
...
intakeUpButton.whenPressed(new RunIntakeArm(true, m_intakeArm) ,true);
...
intakeDownButton.whenPressed(new RunIntakeArm(false, m_intakeArm) ,true);
